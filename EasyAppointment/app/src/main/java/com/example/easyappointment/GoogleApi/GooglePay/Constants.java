package com.example.easyappointment.GoogleApi.GooglePay;
...
public class Constants {
     ...
     */
    public static final String CURRENCY_CODE = "RON";
     ...
     */
    public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("RO", "US", "GB");
